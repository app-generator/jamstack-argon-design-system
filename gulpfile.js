...
gulp.task('watch', function() {
    gulp.watch('src/assets/scss/**/*', ['compile-scss','copy-css', browser.reload]);
...
gulp.task('copy', function() {
    ...
    gulp.src(['src/assets/vendor/**/*']).pipe(gulp.dest('_site/assets/vendor/'));
    gulp.src(['src/assets/img/**/*', '!(*.psd)']).pipe(gulp.dest('_site/assets/img/'));
